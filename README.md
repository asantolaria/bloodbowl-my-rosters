...
| **Tablas de juego** | [Tablas de juego](source/tablas/README.md) · [Carpeta `tablas/`](source/tablas/) | Heridas y lesiones, clima, patada inicial, plegarias de Nuffle, experiencia y SPP. |
