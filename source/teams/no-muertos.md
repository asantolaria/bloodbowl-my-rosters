...
|-----|-----------|-------|----|----|----|----|-----|------------------------|-----|-----|
| 0-16 | Esqueleto | 40k   | 5  | 3  | 4+ | 6+ | 8+  | Regeneración, Cabeza Dura | G  | ADF |
| 0-16 | Zombie    | 40k   | 4  | 3  | 4+ | 6+ | 9+  | Piquete de Ojos, Tembloroso, Regeneración | DG | AF  |
| 0-2 | Necrófago  | 75k   | 7  | 3  | 3+ | 3+ | 8+  | Esquivar, Regeneración | AG | DPF |
| 0-2 | Caballero  | 95k   | 6  | 3  | 3+ | 5+ | 9+  | Cabeza Dura, Placar, Placaje Defensivo, Regeneración | GF | AD  |
| 0-2 | Momia     | 125k  | 3  | 5  | 5+ | 6+ | 10+ | Golpe Mortífero, Regeneración | F  | AG  |

*(**Tembloroso** = inglés *Unsteady*: no puede declarar **Asegurar el balón**. No confundir con **Inestable** = *Unstable*, otro rasgo distinto en otros equipos.)*
...
### Nota de cupos (3ª temporada)

En **BB2025 / 3ª temporada**, cupos oficiales: **Necrófago 0-2**, **Esqueleto** y **Zombie 0-16** cada uno; los **Zombis** incluyen **Piquete de Ojos** y **Tembloroso** (*Unsteady*). Conforme al reglamento Season 3 y la hoja de equipo vigente.
