...
![Amazonas](../images/equipos/amazonas.webp)

Fuente: [Nuffle Zone — Amazonas](https://nufflezone.com/equipos-blood-bowl/amazonas/)

## Roster 2025

| CTD | Posición | Coste | MA | FU | AG | PA | AR | Habilidades (resumen) | Pri | Sec |
|-----|-----------|-------|----|----|----|----|-----|------------------------|-----|-----|
| 0-16 | Guerrera Águila Línea | 50k | 6 | 3 | 3+ | 4+ | 8+ | Esquivar | G | AF |
| 0-2 | Guerrera Pitón Thrower | 80k | 6 | 3 | 3+ | 3+ | 8+ | Atento al Balón, Esquivar, Pasar, Pase Seguro | GP | AF |
| 0-2 | Guerrera Piraña Blitzer | 90k | 7 | 3 | 3+ | 4+ | 8+ | Esquivar, Golpe a la Carrera, En Pie de un Salto | AG | F |
| 0-2 | Guerrera Jaguar Blocker | 110k | 6 | 4 | 3+ | 4+ | 9+ | Esquivar, Romper Defensas | GF | A |
...
* **Pase Seguro (Safe Pass) — incl.:** 1 natural en chequeo de Pase: no balón perdido; mantiene el balón y su activación termina (no cambio de turno).
