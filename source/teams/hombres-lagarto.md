# Hombres Lagarto — Datos 2025

![Hombres Lagarto](../images/equipos/hombres-lagarto.webp)

Fuente: [Nuffle Zone — Hombres Lagarto](https://nufflezone.com/equipos-blood-bowl/hombres-lagarto/)

## Roster 2025

| CTD | Posición      | Coste | MA | FU | AG | PA | AR  | Habilidades (resumen) | Pri | Sec |
|-----|---------------|-------|----|----|----|----|-----|------------------------|-----|-----|
| 0-12 | Eslizón Línea | 60k   | 8  | 2  | 3+ | 4+ | 8+  | Esquivar, Escurridizo | A   | GDPF|
| 0-2 | Camaleón      | 70k   | 7  | 2  | 3+ | 3+ | 8+  | Esquivar, Atento al Balón, Perseguir, Escurridizo | AP | GDF |
| 0-6 | Saurio        | 90k   | 6  | 4  | 5+ | 6+ | 10+ | Imparable, Tembloroso (Unsteady) | GF | A   |
| 0-1 | Kroxigor      | 140k  | 6  | 5  | 5+ | 6+ | 10+ | Cabeza Dura, Estúpido, Cola Prensil, Golpe Mortífero(+1), Solitario(4+) | F  | AG  |
