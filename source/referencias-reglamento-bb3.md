...
- **Derechos:** el contenido del PDF es **propiedad de Games Workshop**. Cada colaborador debe cumplir los términos de uso / licencia que correspondan al publicar o clonar este repositorio.

## Descarga oficial (GW)

- [Blood Bowl — descargas (Warhammer Community)](https://www.warhammer-community.com/blood-bowl-downloads/) — reglas, comentarios de diseño, hojas de referencia (fuente para actualizar la copia local si GW publica revisión).

Detalles de la carpeta: [reglamento/README.md](reglamento/README.md).

## Relación con otras fuentes del repo
