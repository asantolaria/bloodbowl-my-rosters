# Hombres Lagarto — Skill pack 6 habilidades (1.240k)

![Hombres Lagarto](../../source/images/equipos/hombres-lagarto.webp)

> Build Tier 1 estándar (6 primarias). Ver [hombres-lagarto-skill-pack.md](hombres-lagarto-skill-pack.md).
...
|----------|--------|
| **Tier NAF** | Tier 1 |
| **Valoración del equipo (TV)** | 1.240k |
...
*Roster con skill pack aplicado. Habilidades de progresión en **negrita**.*
...
* Ver [hombres-lagarto.md](../../source/teams/hombres-lagarto.md). Habilidades en **negrita** = primaria elegida (+20k).
...
- Cage compacta con Saurios; Placar hace fiables los bloqueos; Guardia gana la línea; Pies Seguros en Eslizón protege vs Strip Ball.
