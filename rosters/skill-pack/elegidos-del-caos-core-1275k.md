# Elegidos del Caos — Skill pack Core competitivo (1.275k)

![Elegidos del Caos](../../source/images/equipos/Chaos.webp)

> Build Core competitivo. Ver [elegidos-del-caos-skill-pack.md](elegidos-del-caos-skill-pack.md). Equipo: [elegidos-del-caos.md](../../source/teams/elegidos-del-caos.md).
...
| Concepto | Coste |
|----------|--------|
| Jugadores (1 Minotauro 150k, 4 Guerrero 400k, 7 Beastman 385k) | 935.000 |
...
|----------|--------|
| **Tier NAF** | Tier 3 |
| **Valoración del equipo (TV)** | 1.275k |
...
* Pack: Bloqueo x2, Guardia x2 en Guerreros; Bloqueo, Manos Seguras en Beastmen; Imparable (primaria) en Minotauro.

## Inducements

- Según reglamento. Típico: Apotecario.

## Estrategia

- Guerreros fuertes desde turno 1. Beastman con Manos Seguras evita Robar Balón. Minotauro blitz con Imparable.

## Progresión

- Ver [elegidos-del-caos-skill-pack.md](elegidos-del-caos-skill-pack.md).
