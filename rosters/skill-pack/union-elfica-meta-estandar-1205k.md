# Union Elfica — Skill pack Meta estándar (1.205k)

![Union Elfica](../../source/images/equipos/union-elfica.webp)

> Build Meta estándar. Ver [union-elfica-skill-pack.md](union-elfica-skill-pack.md). Equipo: [union-elfica.md](../../source/teams/union-elfica.md).
...
|----------|--------|
| **Tier NAF** | Tier 2 |
| **Valoración del equipo (TV)** | 1.205k |
...
| 4  | —      | Elfo Catcher  | 100k  | 8  | 3  | 2+ | 4+ | 8  | Atrapar, Nervios de Acero, Recepción Heroica, **Placar** |
...
* Pack: Esquivar x2 Blitzers; Forcejear y Placar Catchers; Patada y Placaje Defensivo Línea; Líder Lanzador.
...
- Blitzers Blodge más Echarse a un Lado muy difíciles de quitar. Catcher con Forcejear excelente sacker.
